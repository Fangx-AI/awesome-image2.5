> 上游 GPT Image 2 参考资料，尚未由本项目验证为 Image 2.5 输出。来源：[Wuyoscar / openai-cookbook.md](https://github.com/wuyoscar/GPT-Image2-Skill/blob/135d873e1a843db5f122a15ddda02bd2845d4d25/skills/gpt-image/references/openai-cookbook.md) · [MIT 许可](../../vendor/gpt-image2/LICENSE)。原作者及第三方来源标注保留。
...
def display_image_grid(items, width=240):
    ...
    for item in items:
        ...
        cards.append(
            ...
            + label
            + f'<img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/skills/gpt-image/references/{item["path"]}" width="{width}" style="max-width:100%;height:auto;" />'
            + '</div>'
        )
