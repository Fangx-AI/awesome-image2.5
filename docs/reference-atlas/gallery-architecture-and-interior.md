> 上游 GPT Image 2 参考资料，尚未由本项目验证为 Image 2.5 输出。来源：[Wuyoscar / gallery-architecture-and-interior.md](https://github.com/wuyoscar/GPT-Image2-Skill/blob/135d873e1a843db5f122a15ddda02bd2845d4d25/skills/gpt-image/references/gallery-architecture-and-interior.md) · [MIT 许可](../../vendor/gpt-image2/LICENSE)。原作者及第三方来源标注保留。
...
- Image: `docs/architecture-interior/japanese-minimalist-living-room-render.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/architecture-interior/japanese-minimalist-living-room-render.png" alt="japanese minimalist living room render" width="420"/>
...
- Image: `docs/architecture-interior/brutalist-concrete-museum-atrium.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/architecture-interior/brutalist-concrete-museum-atrium.png" alt="brutalist concrete museum atrium" width="420"/>
...
- Image: `docs/architecture-interior/mid-century-modern-office-studio.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/architecture-interior/mid-century-modern-office-studio.png" alt="mid century modern office studio" width="420"/>
- Metadata: Architecture & Interior · `landscape` · `1536x1024` · Curated
...
- Image: `docs/architecture-interior/biophilic-biotech-lab-render.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/architecture-interior/biophilic-biotech-lab-render.png" alt="biophilic biotech lab render" width="420"/>
- Metadata: Architecture & Interior · `wide` · `2048x1152` · Curated
...
- Image: `docs/architecture-interior/gothic-cathedral-interior-render.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/architecture-interior/gothic-cathedral-interior-render.png" alt="gothic cathedral interior render" width="420"/>
