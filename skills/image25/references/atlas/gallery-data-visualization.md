> 上游 GPT Image 2 参考资料，尚未由本项目验证为 Image 2.5 输出。来源：[Wuyoscar / gallery-data-visualization.md](https://github.com/wuyoscar/GPT-Image2-Skill/blob/135d873e1a843db5f122a15ddda02bd2845d4d25/skills/gpt-image/references/gallery-data-visualization.md) · [MIT 许可](https://github.com/Fangx-AI/awesome-image2.5/blob/main/vendor/gpt-image2/LICENSE)。原作者及第三方来源标注保留。
...
- Image: `docs/data-visualization/small-multiples-climate-grid.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/data-visualization/small-multiples-climate-grid.png" alt="small multiples climate grid" width="420"/>
...
- Image: `docs/data-visualization/network-graph-collaboration-map.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/data-visualization/network-graph-collaboration-map.png" alt="network graph collaboration map" width="420"/>
...
- Image: `docs/data-visualization/chord-diagram-energy-flows.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/data-visualization/chord-diagram-energy-flows.png" alt="chord diagram energy flows" width="420"/>
...
- Image: `docs/data-visualization/treemap-startup-budget-allocation.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/data-visualization/treemap-startup-budget-allocation.png" alt="treemap startup budget allocation" width="420"/>
- Metadata: Data Visualization · `landscape` · `1536x1024` · Curated
...
- Image: `docs/data-visualization/geographic-choropleth-harvest-yield.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/data-visualization/geographic-choropleth-harvest-yield.png" alt="geographic choropleth harvest yield" width="420"/>
- Metadata: Data Visualization · `wide` · `2048x1152` · Curated
