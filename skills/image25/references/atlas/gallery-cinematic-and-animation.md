> 上游 GPT Image 2 参考资料，尚未由本项目验证为 Image 2.5 输出。来源：[Wuyoscar / gallery-cinematic-and-animation.md](https://github.com/wuyoscar/GPT-Image2-Skill/blob/135d873e1a843db5f122a15ddda02bd2845d4d25/skills/gpt-image/references/gallery-cinematic-and-animation.md) · [MIT 许可](https://github.com/Fangx-AI/awesome-image2.5/blob/main/vendor/gpt-image2/LICENSE)。原作者及第三方来源标注保留。
...
- Image: `docs/cinematic-animation/pixar-kitchen.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-animation/pixar-kitchen.png" alt="pixar kitchen" width="420"/>
...
- Image: `docs/cinematic-animation/noir-detective.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-animation/noir-detective.png" alt="noir detective" width="420"/>
- Metadata: Cinematic & Animation · `landscape` · `1536x1024` · Curated
...
- Image: `docs/cinematic-animation/storyboard.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-animation/storyboard.png" alt="storyboard" width="420"/>
- Metadata: Cinematic & Animation · `landscape` · `1536x1024` · Curated
...
- Image: `docs/cinematic-animation/ghibli-cottage.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-animation/ghibli-cottage.png" alt="ghibli cottage" width="420"/>
- Metadata: Cinematic & Animation · `landscape` · `1536x1024` · Curated
...
- Image: `docs/cinematic-animation/vhs-grocery-chaos.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-animation/vhs-grocery-chaos.png" alt="vhs grocery chaos" width="420"/>
