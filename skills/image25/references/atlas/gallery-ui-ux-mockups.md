> 上游 GPT Image 2 参考资料，尚未由本项目验证为 Image 2.5 输出。来源：[Wuyoscar / gallery-ui-ux-mockups.md](https://github.com/wuyoscar/GPT-Image2-Skill/blob/135d873e1a843db5f122a15ddda02bd2845d4d25/skills/gpt-image/references/gallery-ui-ux-mockups.md) · [MIT 许可](https://github.com/Fangx-AI/awesome-image2.5/blob/main/vendor/gpt-image2/LICENSE)。原作者及第三方来源标注保留。
...
- Image: `docs/uiux-mockups/mobile-budgeting-app-neobank.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/uiux-mockups/mobile-budgeting-app-neobank.png" alt="mobile budgeting app neobank" width="420"/>
...
- Image: `docs/uiux-mockups/desktop-analytics-dashboard-operations.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/uiux-mockups/desktop-analytics-dashboard-operations.png" alt="desktop analytics dashboard operations" width="420"/>
...
- Image: `docs/uiux-mockups/design-system-component-card-set.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/uiux-mockups/design-system-component-card-set.png" alt="design system component card set" width="420"/>
...
- Image: `docs/uiux-mockups/web3-wallet-app-concept.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/uiux-mockups/web3-wallet-app-concept.png" alt="web3 wallet app concept" width="420"/>
- Metadata: UI/UX Mockups · `portrait` · `1024x1536` · Curated
...
- Image: `docs/uiux-mockups/health-tracker-wellness-app.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/uiux-mockups/health-tracker-wellness-app.png" alt="health tracker wellness app" width="420"/>
- Metadata: UI/UX Mockups · `portrait` · `1024x1536` · Curated
