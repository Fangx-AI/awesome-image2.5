> 上游 GPT Image 2 参考资料，尚未由本项目验证为 Image 2.5 输出。来源：[Wuyoscar / gallery-cinematic-film-references.md](https://github.com/wuyoscar/GPT-Image2-Skill/blob/135d873e1a843db5f122a15ddda02bd2845d4d25/skills/gpt-image/references/gallery-cinematic-film-references.md) · [MIT 许可](https://github.com/Fangx-AI/awesome-image2.5/blob/main/vendor/gpt-image2/LICENSE)。原作者及第三方来源标注保留。
...
- Image: `docs/cinematic-film-references/anderson-symmetric-pastel-hotel.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-film-references/anderson-symmetric-pastel-hotel.png" alt="anderson symmetric pastel hotel" width="420"/>
...
- Image: `docs/cinematic-film-references/villeneuve-monolithic-desert.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-film-references/villeneuve-monolithic-desert.png" alt="villeneuve monolithic desert" width="420"/>
...
- Image: `docs/cinematic-film-references/miyazaki-floating-island-garden.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-film-references/miyazaki-floating-island-garden.png" alt="miyazaki floating island garden" width="420"/>
- Metadata: Cinematic Film References · `landscape` · `1536x1024` · Curated
...
- Image: `docs/cinematic-film-references/tarkovsky-misty-dacha-morning.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-film-references/tarkovsky-misty-dacha-morning.png" alt="tarkovsky misty dacha morning" width="420"/>
- Metadata: Cinematic Film References · `wide` · `2048x1152` · Curated
...
- Image: `docs/cinematic-film-references/blade-runner-neo-noir-orange.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-film-references/blade-runner-neo-noir-orange.png" alt="blade runner neo noir orange" width="420"/>
- Metadata: Cinematic Film References · `wide` · `2048x1152` · Curated
...
- Image: `docs/cinematic-film-references/expressionist-noir-clockwork-alley.png`
  ...
  <img src="https://raw.githubusercontent.com/wuyoscar/GPT-Image2-Skill/135d873e1a843db5f122a15ddda02bd2845d4d25/docs/cinematic-film-references/expressionist-noir-clockwork-alley.png" alt="expressionist noir clockwork alley" width="420"/>
- Metadata: Cinematic Film References · `wide` · `2048x1152` · Curated
