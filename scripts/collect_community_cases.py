...
import argparse,concurrent.futures as cf,json,posixpath,re,subprocess
...
if __name__=="__main__":
 ...
 parser.add_argument('--output',type=Path,default=R/'catalog/community-image25.json')
 ...
 args.output.write_text(json.dumps({"source_repository":REPO,"commit":sha,"records":records},ensure_ascii=False,indent=2)+"\n",encoding="utf-8")
